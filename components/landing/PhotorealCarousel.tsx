...
interface PhotorealCarouselProps {
  images: string[];
}
...
const FALLBACK_BG = [
  'linear-gradient(135deg, #1a0b2e 0%, #080810 100%)',
  'linear-gradient(135deg, #0d1a35 0%, #080810 100%)',
    ...
    <section className="bg-black py-16 overflow-hidden">
      <div className="text-center mb-10 px-6">
        <h2 className="font-display uppercase text-white leading-[0.88]"
          ...
          <em className="font-black italic">LIFELIKE</em>
          <br />
          <span className="font-bold not-italic">PHOTOREAL IMAGES</span>
        </h2>
      </div>
